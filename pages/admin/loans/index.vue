            ...
            <div class="row mb-4">
              <div class="col-12 col-md-12">
                <div class="card redial-border-light redial-shadow mb-4">
                  <div class="card-body">
                    <h6 class="header-title pl-3 redial-relative">Loans</h6>
                    <div v-if="$fetchState.pending">
                      <b-alert show variant="warning">Fetching Loans...</b-alert>
                    </div>
                    <table
...
export default {
  ...
  async fetch() {
    const loans = await this.$axios.$get(
      'https://resource.fvisng.com/api/admin/loans'
    )
