<template>
  <div>
    <Breadcrumb>
      <template v-slot:pagetitle>Overdue Loans</template>
      <template v-slot:breadlinks>
        <ol class="breadcrumb mb-0 bg-transparent redial-light">
          ...
          <li class="breadcrumb-item">
            <NuxtLink to="/admin/manageusers" class="redial-light">Overdue Loans</NuxtLink>
          </li>
        </ol>
      </template>
    </Breadcrumb>
            ...
            <div class="row mb-4">
              <div class="col-12 col-md-12">
                <div class="card redial-border-light redial-shadow mb-4">
                  <div class="card-body">
                    <h6 class="header-title pl-3 redial-relative">Overdue Loans</h6>
                    <div v-if="$fetchState.pending">
                      <b-alert show variant="warning">Fetching Overdue Loans...</b-alert>
                    </div>
                    <table
...
export default {
  ...
  async fetch() {
    const loans = await this.$axios.$get(
      'https://resource.fvisng.com/api/admin/loans/overdue'
    )
