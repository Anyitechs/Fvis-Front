              ...
              <div class="col-12 col-xl-12">
                <div class="card redial-border-light redial-shadow mb-4">
                  <div class="card-body">
                    ...
                    <b-alert show variant="warning" v-if="$auth.user.employ_status == null">
                      <h4 class="alert-heading">Hello {{ firstname }},</h4>
                      <p>Kindly complete your profile to continue with Loan application.</p>
                      <hr />
                      <p class="mb-0"></p>
                    </b-alert>
                    <div class="col-md-8 offset-md-2" v-if="step == 1">
                      <form @submit.prevent="move" novalidate>
                        ...
                        <div class="form-group">
                          <label class="redial-font-weight-600 d-block">
                            ...
                            <input type="text" class="form-control" value="Maximum 2 Months" disabled>
                        </div>
                    ...
                    <div class="col-md-8 offset-md-2" v-else>
                      <form @submit.prevent="submitupload">
                        <div class="form-group">
                          ...
                          />
                          <small class="font-weight-bold">Min amount of &#8358;101,000 and Max amount of &#8358;500,000</small>
                        </div>
                        <div class="form-group">
                          <label class="redial-font-weight-600 d-block">
                          ...
                          <input type="file" class="form-control" @change="statement">
                        </div>
                        <div class="form-group">
                          <label class="redial-font-weight-600 d-block">
                            Employment Letter
                         ...
                         <input type="file" class="form-control" @change="employ_letter">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" v-model="form.guarantor_name">
                          </div>
                          <div class="form-group">
                          <label class="redial-font-weight-600 d-block">
                            Guarantor Number
                          ...
                          <input class="form-control" type="text" v-model="form.guarantor_number">
                          </div>
                        <!-- End of Bank Form -->
                        <button
                          type="submit"
...
export default {
  ...
  methods: {
    async submitupload() {
      ...
      if (
        ...
        formData.append('employ_letter', this.employ_letter)
        ...
        formData.append('guarantor_name', this.form.guarantor_name)
        formData.append('guarantor_number', this.form.guarantor_number)
    ...
    async move() {
      if(!this.form.purpose || !this.form.duration || !this.form.bvn || !this.form.bank.account_name) {
        this.$Toast('Incomplete Fields', 'Kindly complete all fields to proceed')
      } else {
        this.step = 2
      }
    },
    ...
    employ_letter(event) {
      if (event.target.files.length) {
        this.employ_letter = event.target.files[0];
      }
    },
    statement(event) {
      if (event.target.files.length) {
  ...
  watch: {
    ...
    'form.amount': function(val) {
      ...
      if (check > 500000) {
        this.form.amount = 500000
      }
      // if (check < 101000) {
      //   this.form.amount = 101000
      // }
    }
  }
}
